                ...
                <div class="portlet-body form">
                    ...
                    <form id="edit_language" action="" method="post" class="form-horizontal">
                        ...
                        <div class="control-group<?php echo (form_error('code') ? ' error' : ''); ?>">
                            <label class="control-label"><?php echo $lang['iso-639-1']; ?></label>
                            <div class="controls">
                                ...
                                <span class="help-block"><?php echo $lang['iso-639-1_desc']; ?></span>
                            </div>
                        </div>

                        <div class="control-group<?php echo (form_error('encoding') ? ' error' : ''); ?>">
                            <label class="control-label"><?php echo $lang['encoding']; ?></label>
                            <div class="controls">
                                ...
                                <span class="help-block"><?php echo $lang['encoding_desc']; ?></span>
                            </div>
                        </div>
                        ...
                        <div class="control-group<?php echo (form_error('status') ? ' error' : ''); ?>">
                            ...
                            <div class="controls">
                                ...
                                <span class="help-block" style="clear: both;"><?php echo $lang['status_desc']; ?></span>
                            </div>
                        </div>
